...
export default function Products() {
    ...
    return (
        <Layout>
            <Link className="bg-blue-900 text-white py-1 px-2 rounded-md " href={'/admin/products/new'}>
                Add new product
            </Link>
            <h1 className="mt-2 text-blue-900 mb-2 text-xl">Number of products: {products.length}</h1>
